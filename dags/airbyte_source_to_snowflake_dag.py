...
airbyte_postgres_to_snowflake_connection_id = Variable.get("airbyte_postgres_to_snowflake_connection_id")
...
with DAG('04_airbyte_source_to_snowflake_dag',
    ...
    trigger_airbyte_sync = AirbyteTriggerSyncOperator(
        ...
        connection_id=airbyte_postgres_to_snowflake_connection_id,
        asynchronous=True
    )
